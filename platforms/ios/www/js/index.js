var server = 'http://192.168.0.194/workout.tk/'//'http://workout.tk/'
var user;
var storage;
var fav_array =[];
var posts;
            ...
            console.log(content_array)
              ...
              if (i=='list' || i=='favorites') {
                  ...
                  content_array.forEach(function(item){
                            $("#"+id+" .posts").append(
                              '<div class="post flex"><div><a class="single_link" link="'+item.link+'"><div class="icon" style="background-image:url('+server+"icons/"+item.link+'.jpg)" link="'+item.link+'"></div></a></div><div class="info flex"><div class="favorite '+fav_check(item)+'" fav_id="'+item.id+'"></div><a class="single_link" post="'+item.id+'" link="'+item.link+'"><h2>'+item.title+'</h2></a></div></div>'
                              )
                   });
                  calc_pos()
...
xhr.open('POST', 'http://192.168.0.194/workout.tk', true);
